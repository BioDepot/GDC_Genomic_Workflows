...
class OWstarAlign(OWBwBWidget):
    ...
    inputs = [("trigger",str,"handleInputstrigger"),("outputDir",str,"handleInputsoutputDir"),("genomeDir",str,"handleInputsgenomeDir"),("readFilesIn",str,"handleInputsreadFilesIn"),("sampleTriggerGDC",str,"handleInputssampleTriggerGDC"),("starVersion",str,"handleInputsstarVersion"),("sampleTriggerGTEx",str,"handleInputssampleTriggerGTEx")]
    outputs = [("outputDir",str),("genomeDir",str),("starVersion",str),("countFileOut",str)]
    ...
    def handleInputsreadFilesIn(self, value, *args):
        if args and len(args) > 0: 
            ...
            self.handleInputs("inputFile", value, None, False)
    def handleInputssampleTriggerGDC(self, value, *args):
        if args and len(args) > 0: 
            self.handleInputs("sampleTriggerGDC", value, args[0][0], test=args[0][3])
        else:
            self.handleInputs("inputFile", value, None, False)
    def handleInputsstarVersion(self, value, *args):
        if args and len(args) > 0: 
            ...
            self.handleInputs("inputFile", value, None, False)
    def handleInputssampleTriggerGTEx(self, value, *args):
        if args and len(args) > 0: 
            self.handleInputs("sampleTriggerGTEx", value, args[0][0], test=args[0][3])
        else:
            self.handleInputs("inputFile", value, None, False)
    def handleOutputs(self):
        ...
        outputValue="/work/ReadsPerGene.out.tab"
        if hasattr(self,"countFileOut"):
            outputValue=getattr(self,"countFileOut")
        self.send("countFileOut", outputValue)
